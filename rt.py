...
class Rt:
    ...
    def __init__(self, url, default_login=None, default_password=None, proxy=None, default_queue=DEFAULT_QUEUE, http_auth=None):
        """ API initialization.
        ...
        :keyword http_auth: Basic HTTP auth credentials, tuple (UN, PW)
        """
        self.url = url
